...
public class IngestService implements ClusterStateApplier, ReportingService<IngestInfo> {
    ...
    private void runBulkRequestInBatch(
        ...
        // Used to track progress of pipeline execution on index requests across parallel threads
     ...
     * Currently, these are defined by system ingest processors implemented by plugins.
     */
